...
def start( to_input, filePath_input, shippingdocsPath_input, BillPath_input):
    global to, filePath, shippingdocsPath, BillPath
    to = to_input
    filePath = filePath_input
    shippingdocsPath = shippingdocsPath_input
    BillPath = BillPath_input
